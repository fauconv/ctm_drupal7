...
/**
 * change drupal jquery by theme jquery
 * @param type $variables
 */
function ctm_preprocess_html(&$variables) {
 ...
 */
function ctm_breadcrumb($variables) {
 ...
 */
function ctm_date_all_day($variables) {
 ...
 */
function ctm_date_display_range($variables) {
  $same_day = false;
  $date1 = $variables['date1'];
  $date2 = $variables['date2'];
