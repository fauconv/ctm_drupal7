...
/**
 * dans quel environnement sommes nous ?
 * valeurs possibles : 'dev' ou 'rec' ou 'int' ou 'qual' ou 'prod'
 **/
$conf['environnement'] = 'dev';
...
# $conf['proxy_exceptions'] = array('http://'.$_SERVER["SERVER_NAME"],'http://'.$_SERVER["HTTP_HOST"], 'localhost', 'local', '127.0.0.1');
...
$file = dirname(DRUPAL_ROOT).DIRECTORY_SEPARATOR.conf_path().DIRECTORY_SEPARATOR.'settings-'.$conf['environnement'].'-'.$site_dir.'.php';
if(file_exists($file)) {
  include $file;
}
